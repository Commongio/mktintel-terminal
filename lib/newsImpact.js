...
const HIGH = [
  [/fomc|fed (rate|decision|cuts|hikes)|rate (cut|hike|decision)|powell/i, 30, "Fed/rates — moves the whole market"],
...
const SPEAKER_RE = /\b(powell|fed chair|fomc|trump|president|white house|treasury secretary|yellen|bessent|lagarde|ecb|boj|opec)\b/i;
