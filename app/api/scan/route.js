...
const TERMINAL_TOOLS = [
  ...
  { name: "set_theme", description: "Change the terminal background theme. All are lightweight canvas animations. none = classic dot-grid; midnight = drifting fog and ambient dust (the signature theme); obsidian = near-black volcanic glass, almost still; carbon = brushed carbon fibre with a slow reflection; quantum = a neural mesh of drifting nodes; eclipse = off-screen light and shadow; blueprint = technical grid with a scanning pulse; deepcurrent = particles carried by invisible currents; pulse = energy pulses through a still network; aurora = slow ribbons; gridpulse = perspective data-grid.", input_schema: { type: "object", properties: { themeId: { type: "string", enum: ["none", "midnight", "obsidian", "carbon", "quantum", "eclipse", "blueprint", "deepcurrent", "pulse", "aurora", "gridpulse"] } }, required: ["themeId"] } },
